/* =========================================================
   ...
   ✓ Catálogo local como fuente oficial
   ✓ Precios desde js/products.js
   ✓ Disponibilidad desde js/products.js
   ✓ Recomendaciones desde js/products.js
   ✓ Galería
   ✓ Tallas
   ✓ Colores
   ✓ Cantidad
    ...
    const icons = {
        ...
        refresh: `
            ...
            >
                ...
                <path
                    d="M6.1 8a7 7 0 0 1 11.8-2.6L20 7"
                />

                <path
                    d="M17.9 16a7 7 0 0 1-11.8 2.6L4 17"
                />
            </svg>
...
function renderGallery(
    ...
    return `
        ...
        <div
            class="satori-gallery satori-animate satori-animate-left"
        >
                    ...
                    return `
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    data-product-rec-price="${escapeHTML(
                                        String(
                                            item.id
                                        )
                                    )}"
    ...
    if (
        ...
        return `
            ...
            <section
                ...
                data-local-recommendations="true"
            ></section>
...
function getPageCSS() {
    ...
    return `
        ...
        * {
        ...
        .satori-page-ready
        .satori-animate-left.is-visible {
...
<body>
    ...
    >
        ...
        <div
            class="satori-breadcrumb satori-animate"
        >
        ...
        >
            ...
            <div
                class="satori-product-info satori-animate"
            >
    ...
    <section
        class="satori-editorial satori-animate"
    >
...
function generateAll() {
    ...
    console.log(
        "✓ Catálogo: LOCAL (js/products.js)"
    );


    console.log(
        "✓ Supabase eliminado del generador"
    );
